...
def main(args):
    ...
    for i in tqdm(range(finished, len(df))):
        ...
        sim_ori_wm = watermark._sim_after_mapping_sign(original_text, adaptive_watermarked_text)
        sim_ori_para = watermark._sim_after_mapping_sign(original_text, paraphrased_watermarked_text)
        sim_wm_para = watermark._sim_after_mapping_sign(adaptive_watermarked_text, paraphrased_watermarked_text)
